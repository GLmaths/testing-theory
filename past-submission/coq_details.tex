...
\rdef{liftFW} and \rfig{rules-liftFW}.
...
\rlem{liftFW-works}. For every LTS~$\genlts \in \obaFB$, $\liftFW{\genlts} \in \obaFW$.
...
\rlem{acceptance-sets-and-must-sets-have-same-expressivity}.
...
\rlem{completeness-part-2.2-diff-outputs}.
...
\rlem{completeness-part-2.2-auxiliary}.
Let $\genlts_A \in \obaFW$.
...
\rfig{rules-mustset}. Rules to define inductively the predicate $\opMustset$.
