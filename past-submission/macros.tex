...
\newcommand{\testleq}[1][]{\ensuremath{\mathrel{\sqsubsetsim_{\text{\smaller #1}}}}}
...
%\usepackage{amssymb} %% de facto standard
...
%% \newcommand\States{\text{\lstinline|A|}}
%% \newcommand\StatesA{\text{\lstinline|A|}}
%% \newcommand\StatesB{\text{\lstinline|B|}}
%% \newcommand\StatesC{\text{\lstinline|C|}}
\newcommand\StatesA{A}
\newcommand\StatesB{B}
\newcommand\StatesC{C}
